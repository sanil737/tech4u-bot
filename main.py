...
# --- WARNING & BAN TIMER LOGIC (WITH ADMIN PROTECTION) ---
        ...
        if user_data and user_data.get("permits", 0) > 0:
            if i == 1:
                ...
                if member.guild_permissions.administrator:
                    await warn_chan.send(f"⚠️ {member.mention}, you are an Admin so I cannot ban you, but please vouch in <#{VOUCH_CHANNEL_ID}> manually!")
                else:
